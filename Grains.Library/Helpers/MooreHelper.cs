...
{
    public static class MooreHelper
    {
        public static void AddMooreNeighbourhood(this Matrix matrix, int[,] referenceArray, Cell cell)
        {
            matrix.Cells.TrySetValue(referenceArray, cell.Get(-1, -1).NormalizeCell(matrix), 0);
